...
class PatientReport extends Component {
  ...
  getReportOfCurrentWeek = async () => {
    ...
    // .then((response) => {
    //   console.log("response from patient data")
  ...
  getData = async () => {
    ...
    // if (!this.props.patients.patientDataUser) {
    //   window.location.href = "/patientlist";
    // }
    // console.log("getPatientData");
    // console.log("patinetInfo" + this.props.patient.name);
    ...
    // doctor
    //   .doctorRequests()
    //   .getPatientData(this.props.patients.patientDataUser)
    //   .then((response) => {
    //     console.log("recieved getPatientData");

    //     // console.log(response.data)
    //     // for (let value of daysOfWeek) {
    //     //   let tempDate = (moment(value, "MM/DD/YYYY").format("YYYY-MM-DD"))
    //     //   let dayData = response.data.data[tempDate];
    //     //   if (dayData) {
    //     //     console.log("type of" + dayData.totalDuration.$numberDecimal)
    //     //     dayData.totalDuration.$numberDecimal
    //     //       ? tempDur.push(dayData.totalDuration.$numberDecimal)
    //     //       : tempDur.push(null);
    //     //     dayData.totalEpisode.$numberDecimal
    //     //       ? tempEp.push(dayData.totalEpisode.$numberDecimal)
    //     //       : tempEp.push(null);
    //     //   } else {
    //     //     tempEp.push(null);
    //     //     tempDur.push(null);
    ...
    //       ComplianceD: response.data.compliance.totalDays,
    //       ComplianceN: response.data.compliance.CompDays,
    //     });
    //   })
    //   .catch((error) => {
    //     this.setState({
            ...
            <div className="patientReportContainer-box-style">
              <div className="patientReportContainer-rowTwo-grid-2">
                ...
                <div>
                  ...
                  <div className="patientReport-first-text">
  ...
  isLoading={!this.state.lineDataPresent}
> */}
            <div className="patientReportContainer-box-style">
